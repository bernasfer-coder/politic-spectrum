...
assert.equal(GEOGRAPHY_CASES.length, 51);
assert.equal(GEOGRAPHY_LABELS.length, 49);
...
console.log('Geography tests passed: 51 dated cases, 49 unscored labels, citations, boundaries, filters and share URLs.');
