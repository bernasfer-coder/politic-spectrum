...
assert.equal(GEOGRAPHY_CASES.length, 127);
assert.equal(GEOGRAPHY_LABELS.length, 125);
...
console.log('Geography tests passed: 127 dated cases, 125 unscored labels, citations, boundaries, filters and share URLs.');
