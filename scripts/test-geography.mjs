...
assert.equal(GEOGRAPHY_CASES.length, 68);
assert.equal(GEOGRAPHY_LABELS.length, 66);
...
console.log('Geography tests passed: 68 dated cases, 66 unscored labels, citations, boundaries, filters and share URLs.');
