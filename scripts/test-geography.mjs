...
assert.equal(GEOGRAPHY_CASES.length, 91);
assert.equal(GEOGRAPHY_LABELS.length, 89);
...
console.log('Geography tests passed: 91 dated cases, 89 unscored labels, citations, boundaries, filters and share URLs.');
