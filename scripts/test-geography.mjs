...
assert.equal(GEOGRAPHY_CASES.length, 96);
assert.equal(GEOGRAPHY_LABELS.length, 94);
...
assert.equal(filterGeographyCases({ continent: 'Oceania' }).length, 6);
...
console.log('Geography tests passed: 96 dated cases, 94 unscored labels, citations, boundaries, filters and share URLs.');
