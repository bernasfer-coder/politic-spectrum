...
assert.equal(GEOGRAPHY_CASES.length, 140);
assert.equal(GEOGRAPHY_LABELS.length, 138);
...
assert.equal(filterGeographyCases({ period: '2000-onward', relationship: 'implemented' }).length, 118, 'the atlas should expose all dated post-2000 implemented cases');
...
console.log('Geography tests passed: 140 dated cases, 138 unscored labels, citations, boundaries, filters and share URLs.');
