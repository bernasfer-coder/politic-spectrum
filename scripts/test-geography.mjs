...
assert.equal(GEOGRAPHY_CASES.length, 64);
assert.equal(GEOGRAPHY_LABELS.length, 62);
...
console.log('Geography tests passed: 64 dated cases, 62 unscored labels, citations, boundaries, filters and share URLs.');
