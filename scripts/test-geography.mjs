...
assert.equal(GEOGRAPHY_CASES.length, 189);
assert.equal(GEOGRAPHY_LABELS.length, 187);
...
assert.equal(implementedPost2000.length, 163, 'the atlas should expose all dated post-2000 implemented cases');
