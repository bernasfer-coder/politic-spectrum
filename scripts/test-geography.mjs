...
assert.equal(GEOGRAPHY_CASES.length, 90);
assert.equal(GEOGRAPHY_LABELS.length, 88);
...
assert.equal(filterGeographyCases({ period: '2000-onward', relationship: 'implemented' }).length, 68, 'the atlas should expose all dated post-2000 implemented cases');
...
console.log('Geography tests passed: 90 dated cases, 88 unscored labels, citations, boundaries, filters and share URLs.');
