...
assert.equal(GEOGRAPHY_CASES.length, 119);
assert.equal(GEOGRAPHY_LABELS.length, 117);
...
console.log('Geography tests passed: 119 dated cases, 117 unscored labels, citations, boundaries, filters and share URLs.');
