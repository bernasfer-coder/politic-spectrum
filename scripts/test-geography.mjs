...
assert.equal(GEOGRAPHY_CASES.length, 100);
assert.equal(GEOGRAPHY_LABELS.length, 98);
...
console.log('Geography tests passed: 100 dated cases, 98 unscored labels, citations, boundaries, filters and share URLs.');
