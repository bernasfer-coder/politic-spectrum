...
assert.equal(GEOGRAPHY_CASES.length, 20);
assert.equal(GEOGRAPHY_LABELS.length, 18);
...
console.log('Geography tests passed: 20 dated cases, 18 unscored labels, citations, boundaries, filters and share URLs.');
