...
assert.equal(GEOGRAPHY_CASES.length, 136);
assert.equal(GEOGRAPHY_LABELS.length, 134);
...
assert.equal(filterGeographyCases({ period: '2000-onward', relationship: 'implemented' }).length, 114, 'the atlas should expose all dated post-2000 implemented cases');
...
console.log('Geography tests passed: 136 dated cases, 134 unscored labels, citations, boundaries, filters and share URLs.');
