...
assert.equal(GEOGRAPHY_CASES.length, 121);
assert.equal(GEOGRAPHY_LABELS.length, 119);
...
assert.equal(filterGeographyCases({ period: '2000-onward', relationship: 'implemented' }).length, 99, 'the atlas should expose all dated post-2000 implemented cases');
...
console.log('Geography tests passed: 121 dated cases, 119 unscored labels, citations, boundaries, filters and share URLs.');
