...
assert.equal(GEOGRAPHY_CASES.length, 137);
assert.equal(GEOGRAPHY_LABELS.length, 135);
...
assert.equal(filterGeographyCases({ period: '2000-onward', relationship: 'implemented' }).length, 115, 'the atlas should expose all dated post-2000 implemented cases');
...
console.log('Geography tests passed: 137 dated cases, 135 unscored labels, citations, boundaries, filters and share URLs.');
