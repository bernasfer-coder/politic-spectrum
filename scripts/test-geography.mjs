...
assert.equal(GEOGRAPHY_CASES.length, 125);
assert.equal(GEOGRAPHY_LABELS.length, 123);
...
assert.equal(filterGeographyCases({ period: '2000-onward', relationship: 'implemented' }).length, 103, 'the atlas should expose all dated post-2000 implemented cases');
...
console.log('Geography tests passed: 125 dated cases, 123 unscored labels, citations, boundaries, filters and share URLs.');
