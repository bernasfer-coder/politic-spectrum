...
assert.equal(GEOGRAPHY_CASES.length, 80);
assert.equal(GEOGRAPHY_LABELS.length, 78);
...
assert.equal(filterGeographyCases({ period: '2000-onward', relationship: 'implemented' }).length, 58, 'the atlas should expose all dated post-2000 implemented cases');
...
console.log('Geography tests passed: 80 dated cases, 78 unscored labels, citations, boundaries, filters and share URLs.');
