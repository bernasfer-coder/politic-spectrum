...
assert.equal(GEOGRAPHY_CASES.length, 104);
assert.equal(GEOGRAPHY_LABELS.length, 102);
...
console.log('Geography tests passed: 104 dated cases, 102 unscored labels, citations, boundaries, filters and share URLs.');
