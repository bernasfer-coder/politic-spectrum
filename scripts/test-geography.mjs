...
assert.equal(GEOGRAPHY_CASES.length, 203);
assert.equal(GEOGRAPHY_LABELS.length, 201);
...
assert.equal(implementedPost2000.length, 176, 'the atlas should expose all dated post-2000 implemented cases');
