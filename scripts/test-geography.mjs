...
assert.equal(GEOGRAPHY_CASES.length, 78);
assert.equal(GEOGRAPHY_LABELS.length, 76);
...
assert.equal(filterGeographyCases({ period: '2000-onward', relationship: 'implemented' }).length, 56, 'the atlas should expose all dated post-2000 implemented cases');
...
console.log('Geography tests passed: 78 dated cases, 76 unscored labels, citations, boundaries, filters and share URLs.');
