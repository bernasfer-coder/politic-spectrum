...
assert.equal(GEOGRAPHY_CASES.length, 149);
assert.equal(GEOGRAPHY_LABELS.length, 147);
...
assert.equal(filterGeographyCases({ period: '2000-onward', relationship: 'implemented' }).length, 127, 'the atlas should expose all dated post-2000 implemented cases');
...
console.log('Geography tests passed: 149 dated cases, 147 unscored labels, citations, boundaries, filters and share URLs.');
