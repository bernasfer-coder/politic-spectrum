...
assert.equal(GEOGRAPHY_CASES.length, 71);
assert.equal(GEOGRAPHY_LABELS.length, 69);
...
console.log('Geography tests passed: 71 dated cases, 69 unscored labels, citations, boundaries, filters and share URLs.');
