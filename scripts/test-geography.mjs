...
assert.equal(filterGeographyCases({ country: 'india' }).find(({ id }) => id === 'india-women-reservation-commencement-and-delimitation-contest-2026')?.id, 'india-women-reservation-commencement-and-delimitation-contest-2026');
