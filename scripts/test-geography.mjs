...
assert.equal(GEOGRAPHY_CASES.length, 86);
assert.equal(GEOGRAPHY_LABELS.length, 84);
...
console.log('Geography tests passed: 86 dated cases, 84 unscored labels, citations, boundaries, filters and share URLs.');
