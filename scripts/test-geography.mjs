...
assert.equal(GEOGRAPHY_CASES.length, 123);
assert.equal(GEOGRAPHY_LABELS.length, 121);
...
assert.equal(filterGeographyCases({ period: '2000-onward', relationship: 'implemented' }).length, 101, 'the atlas should expose all dated post-2000 implemented cases');
...
console.log('Geography tests passed: 123 dated cases, 121 unscored labels, citations, boundaries, filters and share URLs.');
