...
assert.equal(GEOGRAPHY_CASES.length, 186);
assert.equal(GEOGRAPHY_LABELS.length, 184);
...
assert.equal(implementedPost2000.length, 160, 'the atlas should expose all dated post-2000 implemented cases');
