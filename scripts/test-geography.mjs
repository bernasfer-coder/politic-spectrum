...
const sriLankaNppCase = GEOGRAPHY_CASES.find(({ id }) => id === 'sri-lankan-npp-electoral-transition-and-governing-period');
...
console.log('Geography tests passed: 112 cases, 110 unscored labels, citations, boundaries, filters and share URLs.');
