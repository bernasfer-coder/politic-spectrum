...
assert.equal(GEOGRAPHY_CASES.length, 57);
assert.equal(GEOGRAPHY_LABELS.length, 55);
...
console.log('Geography tests passed: 57 dated cases, 55 unscored labels, citations, boundaries, filters and share URLs.');
