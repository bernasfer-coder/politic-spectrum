...
assert.equal(GEOGRAPHY_CASES.length, 15);
assert.equal(GEOGRAPHY_LABELS.length, 13);
...
console.log('Geography tests passed: 15 dated cases, 13 unscored labels, citations, boundaries, filters and share URLs.');
