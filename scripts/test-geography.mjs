...
assert.equal(GEOGRAPHY_CASES.length, 142);
assert.equal(GEOGRAPHY_LABELS.length, 140);
...
assert.equal(filterGeographyCases({ period: '2000-onward', relationship: 'implemented' }).length, 120, 'the atlas should expose all dated post-2000 implemented cases');
...
console.log('Geography tests passed: 142 dated cases, 140 unscored labels, citations, boundaries, filters and share URLs.');
