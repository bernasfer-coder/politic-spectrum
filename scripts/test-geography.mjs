...
assert.equal(GEOGRAPHY_CASES.length, 169);
assert.equal(GEOGRAPHY_LABELS.length, 167);
...
assert.equal(implementedPost2000.length, 145, 'the atlas should expose all dated post-2000 implemented cases');
...
console.log('Geography tests passed: 169 dated cases, 167 unscored labels, citations, boundaries, filters and share URLs.');
