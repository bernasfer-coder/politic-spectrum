...
assert.equal(GEOGRAPHY_CASES.length, 106);
assert.equal(GEOGRAPHY_LABELS.length, 104);
...
console.log('Geography tests passed: 106 dated cases, 104 unscored labels, citations, boundaries, filters and share URLs.');
