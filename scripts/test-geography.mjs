...
assert.equal(GEOGRAPHY_CASES.length, 94);
assert.equal(GEOGRAPHY_LABELS.length, 92);
...
assert.equal(filterGeographyCases({ continent: 'Oceania' }).length, 4);
...
console.log('Geography tests passed: 94 dated cases, 92 unscored labels, citations, boundaries, filters and share URLs.');
