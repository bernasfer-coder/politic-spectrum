...
assert.equal(GEOGRAPHY_CASES.length, 66);
assert.equal(GEOGRAPHY_LABELS.length, 64);
...
console.log('Geography tests passed: 66 dated cases, 64 unscored labels, citations, boundaries, filters and share URLs.');
