...
assert.equal(GEOGRAPHY_CASES.length, 150);
assert.equal(GEOGRAPHY_LABELS.length, 148);
...
assert.equal(filterGeographyCases({ period: '2000-onward', relationship: 'implemented' }).length, 128, 'the atlas should expose all dated post-2000 implemented cases');
...
console.log('Geography tests passed: 150 dated cases, 148 unscored labels, citations, boundaries, filters and share URLs.');
