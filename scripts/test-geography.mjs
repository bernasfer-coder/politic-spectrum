...
assert.equal(GEOGRAPHY_CASES.length, 141);
assert.equal(GEOGRAPHY_LABELS.length, 139);
...
console.log('Geography tests passed: 141 dated cases, 139 unscored labels, citations, boundaries, filters and share URLs.');
