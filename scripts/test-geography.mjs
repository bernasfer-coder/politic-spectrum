...
assert.equal(GEOGRAPHY_CASES.length, 89);
assert.equal(GEOGRAPHY_LABELS.length, 87);
...
console.log('Geography tests passed: 89 dated cases, 87 unscored labels, citations, boundaries, filters and share URLs.');
