...
assert.equal(GEOGRAPHY_CASES.length, 72);
assert.equal(GEOGRAPHY_LABELS.length, 70);
...
console.log('Geography tests passed: 72 dated cases, 70 unscored labels, citations, boundaries, filters and share URLs.');
