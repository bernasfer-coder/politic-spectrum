...
assert.equal(GEOGRAPHY_CASES.length, 213);
assert.equal(GEOGRAPHY_LABELS.length, 211);
...
assert.equal(implementedPost2000.length, 185, 'the atlas should expose all dated post-2000 implemented cases');
