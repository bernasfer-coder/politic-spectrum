...
assert.equal(GEOGRAPHY_CASES.length, 152);
assert.equal(GEOGRAPHY_LABELS.length, 150);
...
assert.equal(filterGeographyCases({ period: '2000-onward', relationship: 'implemented' }).length, 130, 'the atlas should expose all dated post-2000 implemented cases');
...
console.log('Geography tests passed: 152 dated cases, 150 unscored labels, citations, boundaries, filters and share URLs.');
