...
assert.equal(GEOGRAPHY_CASES.length, 59);
assert.equal(GEOGRAPHY_LABELS.length, 57);
...
console.log('Geography tests passed: 59 dated cases, 57 unscored labels, citations, boundaries, filters and share URLs.');
