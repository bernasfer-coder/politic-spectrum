...
assert.equal(GEOGRAPHY_CASES.length, 124);
assert.equal(GEOGRAPHY_LABELS.length, 122);
...
assert.equal(filterGeographyCases({ period: '2000-onward', relationship: 'implemented' }).length, 102, 'the atlas should expose all dated post-2000 implemented cases');
...
console.log('Geography tests passed: 124 dated cases, 122 unscored labels, citations, boundaries, filters and share URLs.');
