...
assert.equal(GEOGRAPHY_CASES.length, 131);
assert.equal(GEOGRAPHY_LABELS.length, 129);
...
assert.equal(filterGeographyCases({ period: '2000-onward', relationship: 'implemented' }).length, 109, 'the atlas should expose all dated post-2000 implemented cases');
...
console.log('Geography tests passed: 131 dated cases, 129 unscored labels, citations, boundaries, filters and share URLs.');
