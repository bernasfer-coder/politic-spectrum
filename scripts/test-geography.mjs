...
assert.equal(GEOGRAPHY_CASES.length, 195);
assert.equal(GEOGRAPHY_LABELS.length, 193);
...
assert.equal(implementedPost2000.length, 168, 'the atlas should expose all dated post-2000 implemented cases');
