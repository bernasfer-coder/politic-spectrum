...
assert.equal(GEOGRAPHY_CASES.length, 115);
assert.equal(GEOGRAPHY_LABELS.length, 113);
...
assert.equal(filterGeographyCases({ period: '2000-onward', relationship: 'implemented' }).length, 93, 'the atlas should expose all dated post-2000 implemented cases');
...
console.log('Geography tests passed: 115 dated cases, 113 unscored labels, citations, boundaries, filters and share URLs.');
