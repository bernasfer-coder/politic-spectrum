...
assert.equal(GEOGRAPHY_CASES.length, 85);
assert.equal(GEOGRAPHY_LABELS.length, 83);
...
console.log('Geography tests passed: 85 dated cases, 83 unscored labels, citations, boundaries, filters and share URLs.');
