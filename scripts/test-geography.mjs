...
assert.equal(GEOGRAPHY_CASES.length, 101);
assert.equal(GEOGRAPHY_LABELS.length, 99);
...
console.log('Geography tests passed: 101 dated cases, 99 unscored labels, citations, boundaries, filters and share URLs.');
