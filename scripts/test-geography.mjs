...
assert.equal(GEOGRAPHY_CASES.length, 67);
assert.equal(GEOGRAPHY_LABELS.length, 65);
...
console.log('Geography tests passed: 67 dated cases, 65 unscored labels, citations, boundaries, filters and share URLs.');
