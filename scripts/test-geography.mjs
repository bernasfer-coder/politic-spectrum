...
assert.equal(GEOGRAPHY_CASES.length, 53);
assert.equal(GEOGRAPHY_LABELS.length, 51);
...
console.log('Geography tests passed: 53 dated cases, 51 unscored labels, citations, boundaries, filters and share URLs.');
