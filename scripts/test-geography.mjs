...
assert.equal(GEOGRAPHY_CASES.length, 114);
assert.equal(GEOGRAPHY_LABELS.length, 112);
...
assert.equal(filterGeographyCases({ period: '2000-onward', relationship: 'implemented' }).length, 92, 'the atlas should expose all dated post-2000 implemented cases');
...
console.log('Geography tests passed: 114 dated cases, 112 unscored labels, citations, boundaries, filters and share URLs.');
