...
assert.equal(GEOGRAPHY_CASES.length, 79);
assert.equal(GEOGRAPHY_LABELS.length, 77);
...
assert.equal(filterGeographyCases({ period: '2000-onward', relationship: 'implemented' }).length, 57, 'the atlas should expose all dated post-2000 implemented cases');
...
console.log('Geography tests passed: 79 dated cases, 77 unscored labels, citations, boundaries, filters and share URLs.');
