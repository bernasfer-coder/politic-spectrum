...
assert.equal(GEOGRAPHY_CASES.length, 201);
assert.equal(GEOGRAPHY_LABELS.length, 199);
...
assert.equal(implementedPost2000.length, 174, 'the atlas should expose all dated post-2000 implemented cases');
