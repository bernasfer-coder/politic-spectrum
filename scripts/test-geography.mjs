...
assert.equal(GEOGRAPHY_CASES.length, 74);
assert.equal(GEOGRAPHY_LABELS.length, 72);
...
assert.equal(filterGeographyCases({ period: '2000-onward', relationship: 'implemented' }).length, 52, 'the atlas should expose all dated post-2000 implemented cases');
...
console.log('Geography tests passed: 74 dated cases, 72 unscored labels, citations, boundaries, filters and share URLs.');
