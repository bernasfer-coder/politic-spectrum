...
assert.equal(GEOGRAPHY_CASES.length, 198);
assert.equal(GEOGRAPHY_LABELS.length, 196);
...
assert.equal(implementedPost2000.length, 171, 'the atlas should expose all dated post-2000 implemented cases');
