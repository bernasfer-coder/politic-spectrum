...
assert.equal(GEOGRAPHY_CASES.length, 63);
assert.equal(GEOGRAPHY_LABELS.length, 61);
...
console.log('Geography tests passed: 63 dated cases, 61 unscored labels, citations, boundaries, filters and share URLs.');
