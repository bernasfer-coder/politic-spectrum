...
assert.equal(filterGeographyCases({ country: 'ghana' }).find(({ id }) => id === 'ghanaian-post-2024-electoral-alternation-and-reset-transition')?.id, 'ghanaian-post-2024-electoral-alternation-and-reset-transition');
