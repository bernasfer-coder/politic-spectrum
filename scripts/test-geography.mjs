...
assert.equal(GEOGRAPHY_CASES.length, 98);
assert.equal(GEOGRAPHY_LABELS.length, 96);
...
console.log('Geography tests passed: 98 dated cases, 96 unscored labels, citations, boundaries, filters and share URLs.');
