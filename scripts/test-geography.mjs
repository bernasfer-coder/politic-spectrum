...
assert.equal(GEOGRAPHY_CASES.length, 135);
assert.equal(GEOGRAPHY_LABELS.length, 133);
...
assert.equal(filterGeographyCases({ continent: 'Oceania' }).length, 9);
...
console.log('Geography tests passed: 135 dated cases, 133 unscored labels, citations, boundaries, filters and share URLs.');
