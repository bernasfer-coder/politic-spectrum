...
assert.equal(GEOGRAPHY_CASES.length, 61);
assert.equal(GEOGRAPHY_LABELS.length, 59);
...
console.log('Geography tests passed: 61 dated cases, 59 unscored labels, citations, boundaries, filters and share URLs.');
