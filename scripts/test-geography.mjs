...
assert.equal(GEOGRAPHY_CASES.length, 102);
assert.equal(GEOGRAPHY_LABELS.length, 100);
...
console.log('Geography tests passed: 102 dated cases, 100 unscored labels, citations, boundaries, filters and share URLs.');
