...
assert.equal(GEOGRAPHY_CASES.length, 84);
assert.equal(GEOGRAPHY_LABELS.length, 82);
...
assert.equal(filterGeographyCases({ period: '2000-onward', relationship: 'implemented' }).length, 62, 'the atlas should expose all dated post-2000 implemented cases');
...
console.log('Geography tests passed: 84 dated cases, 82 unscored labels, citations, boundaries, filters and share URLs.');
