...
assert.equal(GEOGRAPHY_CASES.length, 134);
assert.equal(GEOGRAPHY_LABELS.length, 132);
...
assert.equal(filterGeographyCases({ period: '2000-onward', relationship: 'implemented' }).length, 112, 'the atlas should expose all dated post-2000 implemented cases');
...
console.log('Geography tests passed: 134 dated cases, 132 unscored labels, citations, boundaries, filters and share URLs.');
