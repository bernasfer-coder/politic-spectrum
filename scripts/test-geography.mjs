...
assert.equal(GEOGRAPHY_CASES.length, 83);
assert.equal(GEOGRAPHY_LABELS.length, 81);
...
assert.equal(filterGeographyCases({ period: '2000-onward', relationship: 'implemented' }).length, 61, 'the atlas should expose all dated post-2000 implemented cases');
...
console.log('Geography tests passed: 83 dated cases, 81 unscored labels, citations, boundaries, filters and share URLs.');
