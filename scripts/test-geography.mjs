...
assert.equal(GEOGRAPHY_CASES.length, 65);
assert.equal(GEOGRAPHY_LABELS.length, 63);
...
console.log('Geography tests passed: 65 dated cases, 63 unscored labels, citations, boundaries, filters and share URLs.');
