...
assert.equal(filterGeographyCases({ country: 'france' }).find(({ id }) => id === 'french-post-2024-fragmented-parliamentary-and-budget-order')?.id, 'french-post-2024-fragmented-parliamentary-and-budget-order');
