...
assert.equal(GEOGRAPHY_CASES.length, 128);
assert.equal(GEOGRAPHY_LABELS.length, 126);
...
assert.equal(filterGeographyCases({ period: '2000-onward', relationship: 'implemented' }).length, 106, 'the atlas should expose all dated post-2000 implemented cases');
...
console.log('Geography tests passed: 128 dated cases, 126 unscored labels, citations, boundaries, filters and share URLs.');
