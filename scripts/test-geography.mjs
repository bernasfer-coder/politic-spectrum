...
assert.equal(GEOGRAPHY_CASES.length, 212);
assert.equal(GEOGRAPHY_LABELS.length, 210);
...
assert.equal(implementedPost2000.length, 184, 'the atlas should expose all dated post-2000 implemented cases');
