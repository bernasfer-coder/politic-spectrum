...
assert.equal(GEOGRAPHY_CASES.length, 167);
assert.equal(GEOGRAPHY_LABELS.length, 165);
...
assert.equal(implementedPost2000.length, 144, 'the atlas should expose all dated post-2000 implemented cases');
...
console.log('Geography tests passed: 167 dated cases, 165 unscored labels, citations, boundaries, filters and share URLs.');
