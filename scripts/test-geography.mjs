...
assert.ok(GEOGRAPHY_CASES.some((item) => item.id === 'colombian-2026-presidential-alternation-and-contested-electoral-order' && item.placeId === 'colombia' && item.startYear === 2026 && item.endYear === 2026));
assert.ok(GEOGRAPHY_CASES.some((item) => item.id === 'bangladeshi-post-2024-interim-and-electoral-transition' && item.placeId === 'bangladesh' && item.startYear === 2024 && item.endYear === 2026 && item.confidence === 'medium'));
