...
assert.equal(GEOGRAPHY_CASES.length, 133);
assert.equal(GEOGRAPHY_LABELS.length, 131);
...
assert.equal(filterGeographyCases({ period: '2000-onward', relationship: 'implemented' }).length, 111, 'the atlas should expose all dated post-2000 implemented cases');
...
console.log('Geography tests passed: 133 dated cases, 131 unscored labels, citations, boundaries, filters and share URLs.');
