...
assert.equal(GEOGRAPHY_CASES.length, 81);
assert.equal(GEOGRAPHY_LABELS.length, 79);
...
console.log('Geography tests passed: 81 dated cases, 79 unscored labels, citations, boundaries, filters and share URLs.');
