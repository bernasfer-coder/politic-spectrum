...
assert.equal(GEOGRAPHY_CASES.length, 138);
assert.equal(GEOGRAPHY_LABELS.length, 136);
...
assert.equal(filterGeographyCases({ period: '2000-onward', relationship: 'implemented' }).length, 116, 'the atlas should expose all dated post-2000 implemented cases');
...
console.log('Geography tests passed: 138 dated cases, 136 unscored labels, citations, boundaries, filters and share URLs.');
