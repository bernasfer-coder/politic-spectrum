...
assert.equal(GEOGRAPHY_CASES.length, 168);
assert.equal(GEOGRAPHY_LABELS.length, 166);
...
console.log('Geography tests passed: 168 dated cases, 166 unscored labels, citations, boundaries, filters and share URLs.');
