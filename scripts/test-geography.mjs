...
assert.equal(GEOGRAPHY_CASES.length, 146);
assert.equal(GEOGRAPHY_LABELS.length, 144);
...
assert.equal(filterGeographyCases({ period: '2000-onward', relationship: 'implemented' }).length, 124, 'the atlas should expose all dated post-2000 implemented cases');
...
console.log('Geography tests passed: 146 dated cases, 144 unscored labels, citations, boundaries, filters and share URLs.');
