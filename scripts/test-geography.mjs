...
assert.equal(GEOGRAPHY_CASES.length, 69);
assert.equal(GEOGRAPHY_LABELS.length, 67);
...
console.log('Geography tests passed: 69 dated cases, 67 unscored labels, citations, boundaries, filters and share URLs.');
