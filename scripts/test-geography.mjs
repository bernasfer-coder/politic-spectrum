...
assert.equal(GEOGRAPHY_CASES.length, 76);
assert.equal(GEOGRAPHY_LABELS.length, 74);
...
console.log('Geography tests passed: 76 dated cases, 74 unscored labels, citations, boundaries, filters and share URLs.');
