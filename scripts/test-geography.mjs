...
assert.equal(GEOGRAPHY_CASES.length, 214);
assert.equal(GEOGRAPHY_LABELS.length, 212);
...
assert.equal(implementedPost2000.length, 186, 'the atlas should expose all dated post-2000 implemented cases');
