...
assert.equal(GEOGRAPHY_CASES.length, 108);
assert.equal(GEOGRAPHY_LABELS.length, 106);
...
console.log('Geography tests passed: 108 dated cases, 106 unscored labels, citations, boundaries, filters and share URLs.');
