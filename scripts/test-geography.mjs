...
assert.equal(GEOGRAPHY_CASES.length, 154);
assert.equal(GEOGRAPHY_LABELS.length, 152);
...
assert.equal(filterGeographyCases({ period: '2000-onward', relationship: 'implemented' }).length, 132, 'the atlas should expose all dated post-2000 implemented cases');
...
console.log('Geography tests passed: 154 dated cases, 152 unscored labels, citations, boundaries, filters and share URLs.');
