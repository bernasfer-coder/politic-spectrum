...
assert.equal(GEOGRAPHY_CASES.length, 82);
assert.equal(GEOGRAPHY_LABELS.length, 80);
...
assert.equal(filterGeographyCases({ period: '2000-onward', relationship: 'implemented' }).length, 60, 'the atlas should expose all dated post-2000 implemented cases');
...
console.log('Geography tests passed: 82 dated cases, 80 unscored labels, citations, boundaries, filters and share URLs.');
