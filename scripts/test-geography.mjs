...
assert.equal(GEOGRAPHY_CASES.length, 54);
assert.equal(GEOGRAPHY_LABELS.length, 52);
...
console.log('Geography tests passed: 54 dated cases, 52 unscored labels, citations, boundaries, filters and share URLs.');
