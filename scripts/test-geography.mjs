...
assert.equal(GEOGRAPHY_CASES.length, 204);
assert.equal(GEOGRAPHY_LABELS.length, 202);
...
assert.equal(implementedPost2000.length, 177, 'the atlas should expose all dated post-2000 implemented cases');
