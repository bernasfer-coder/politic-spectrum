...
assert.equal(GEOGRAPHY_CASES.length, 126);
assert.equal(GEOGRAPHY_LABELS.length, 124);
...
console.log('Geography tests passed: 126 dated cases, 124 unscored labels, citations, boundaries, filters and share URLs.');
