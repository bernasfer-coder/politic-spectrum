...
assert.equal(GEOGRAPHY_CASES.length, 153);
assert.equal(GEOGRAPHY_LABELS.length, 151);
...
assert.equal(filterGeographyCases({ period: '2000-onward', relationship: 'implemented' }).length, 131, 'the atlas should expose all dated post-2000 implemented cases');
...
console.log('Geography tests passed: 153 dated cases, 151 unscored labels, citations, boundaries, filters and share URLs.');
