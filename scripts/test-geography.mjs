...
assert.equal(GEOGRAPHY_CASES.length, 122);
assert.equal(GEOGRAPHY_LABELS.length, 120);
...
assert.equal(filterGeographyCases({ period: '2000-onward', relationship: 'implemented' }).length, 100, 'the atlas should expose all dated post-2000 implemented cases');
...
console.log('Geography tests passed: 122 dated cases, 120 unscored labels, citations, boundaries, filters and share URLs.');
