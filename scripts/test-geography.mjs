...
assert.equal(GEOGRAPHY_CASES.length, 130);
assert.equal(GEOGRAPHY_LABELS.length, 128);
...
assert.equal(filterGeographyCases({ period: '2000-onward', relationship: 'implemented' }).length, 108, 'the atlas should expose all dated post-2000 implemented cases');
...
console.log('Geography tests passed: 130 dated cases, 128 unscored labels, citations, boundaries, filters and share URLs.');
