...
assert.equal(GEOGRAPHY_CASES.length, 70);
assert.equal(GEOGRAPHY_LABELS.length, 68);
...
console.log('Geography tests passed: 70 dated cases, 68 unscored labels, citations, boundaries, filters and share URLs.');
