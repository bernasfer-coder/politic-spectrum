...
assert.equal(GEOGRAPHY_CASES.length, 116);
assert.equal(GEOGRAPHY_LABELS.length, 114);
...
assert.equal(filterGeographyCases({ period: '2000-onward', relationship: 'implemented' }).length, 94, 'the atlas should expose all dated post-2000 implemented cases');
...
console.log('Geography tests passed: 116 dated cases, 114 unscored labels, citations, boundaries, filters and share URLs.');
