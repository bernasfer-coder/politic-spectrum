...
assert.equal(GEOGRAPHY_CASES.length, 60);
assert.equal(GEOGRAPHY_LABELS.length, 58);
...
console.log('Geography tests passed: 60 dated cases, 58 unscored labels, citations, boundaries, filters and share URLs.');
