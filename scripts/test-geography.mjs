...
assert.equal(GEOGRAPHY_CASES.length, 75);
assert.equal(GEOGRAPHY_LABELS.length, 73);
...
console.log('Geography tests passed: 75 dated cases, 73 unscored labels, citations, boundaries, filters and share URLs.');
