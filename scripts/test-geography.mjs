...
assert.equal(GEOGRAPHY_CASES.length, 62);
assert.equal(GEOGRAPHY_LABELS.length, 60);
...
console.log('Geography tests passed: 62 dated cases, 60 unscored labels, citations, boundaries, filters and share URLs.');
