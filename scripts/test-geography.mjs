...
assert.equal(GEOGRAPHY_CASES.length, 132);
assert.equal(GEOGRAPHY_LABELS.length, 130);
...
assert.equal(filterGeographyCases({ period: '2000-onward', relationship: 'implemented' }).length, 110, 'the atlas should expose all dated post-2000 implemented cases');
...
console.log('Geography tests passed: 132 dated cases, 130 unscored labels, citations, boundaries, filters and share URLs.');
