...
assert.equal(GEOGRAPHY_CASES.length, 97);
assert.equal(GEOGRAPHY_LABELS.length, 95);
...
console.log('Geography tests passed: 97 dated cases, 95 unscored labels, citations, boundaries, filters and share URLs.');
