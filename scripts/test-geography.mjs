...
assert.equal(GEOGRAPHY_CASES.length, 105);
assert.equal(GEOGRAPHY_LABELS.length, 103);
...
console.log('Geography tests passed: 105 dated cases, 103 unscored labels, citations, boundaries, filters and share URLs.');
