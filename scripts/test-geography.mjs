...
assert.equal(GEOGRAPHY_CASES.length, 120);
assert.equal(GEOGRAPHY_LABELS.length, 118);
...
assert.equal(filterGeographyCases({ period: '2000-onward', relationship: 'implemented' }).length, 98, 'the atlas should expose all dated post-2000 implemented cases');
...
console.log('Geography tests passed: 120 dated cases, 118 unscored labels, citations, boundaries, filters and share URLs.');
