...
assert.ok(filterGeographyCases({ country: 'pakistan' }).some(({ id }) => id === 'pakistani-26th-27th-amendment-constitutional-restructuring'));
assert.equal(filterGeographyCases({ case: 'pakistani-26th-27th-amendment-constitutional-restructuring' }).length, 1);
