...
assert.equal(GEOGRAPHY_CASES.length, 88);
assert.equal(GEOGRAPHY_LABELS.length, 86);
...
console.log('Geography tests passed: 88 dated cases, 86 unscored labels, citations, boundaries, filters and share URLs.');
