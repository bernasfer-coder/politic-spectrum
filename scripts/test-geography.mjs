...
assert.equal(GEOGRAPHY_CASES.length, 202);
assert.equal(GEOGRAPHY_LABELS.length, 200);
...
assert.equal(implementedPost2000.length, 175, 'the atlas should expose all dated post-2000 implemented cases');
