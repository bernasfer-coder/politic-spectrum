...
assert.equal(GEOGRAPHY_CASES.length, 117);
assert.equal(GEOGRAPHY_LABELS.length, 115);
...
console.log('Geography tests passed: 117 dated cases, 115 unscored labels, citations, boundaries, filters and share URLs.');
