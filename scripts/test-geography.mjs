...
assert.equal(GEOGRAPHY_CASES.length, 185);
assert.equal(GEOGRAPHY_LABELS.length, 183);
...
assert.equal(implementedPost2000.length, 159, 'the atlas should expose all dated post-2000 implemented cases');
