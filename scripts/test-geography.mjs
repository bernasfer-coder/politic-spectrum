...
assert.equal(GEOGRAPHY_CASES.length, 18);
assert.equal(GEOGRAPHY_LABELS.length, 16);
...
console.log('Geography tests passed: 18 dated cases, 16 unscored labels, citations, boundaries, filters and share URLs.');
