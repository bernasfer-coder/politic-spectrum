...
assert.equal(GEOGRAPHY_CASES.length, 118);
assert.equal(GEOGRAPHY_LABELS.length, 116);
...
assert.equal(filterGeographyCases({ period: '2000-onward', relationship: 'implemented' }).length, 96, 'the atlas should expose all dated post-2000 implemented cases');
...
console.log('Geography tests passed: 118 dated cases, 116 unscored labels, citations, boundaries, filters and share URLs.');
