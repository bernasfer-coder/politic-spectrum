...
assert.equal(GEOGRAPHY_CASES.length, 19);
assert.equal(GEOGRAPHY_LABELS.length, 17);
...
console.log('Geography tests passed: 19 dated cases, 17 unscored labels, citations, boundaries, filters and share URLs.');
