...
assert.equal(GEOGRAPHY_CASES.length, 129);
assert.equal(GEOGRAPHY_LABELS.length, 127);
...
assert.equal(filterGeographyCases({ period: '2000-onward', relationship: 'implemented' }).length, 107, 'the atlas should expose all dated post-2000 implemented cases');
...
console.log('Geography tests passed: 129 dated cases, 127 unscored labels, citations, boundaries, filters and share URLs.');
