...
assert.equal(GEOGRAPHY_CASES.length, 107);
assert.equal(GEOGRAPHY_LABELS.length, 105);
...
console.log('Geography tests passed: 107 dated cases, 105 unscored labels, citations, boundaries, filters and share URLs.');
