...
assert.equal(GEOGRAPHY_CASES.length, 145);
assert.equal(GEOGRAPHY_LABELS.length, 143);
...
assert.equal(filterGeographyCases({ period: '2000-onward', relationship: 'implemented' }).length, 123, 'the atlas should expose all dated post-2000 implemented cases');
...
console.log('Geography tests passed: 145 dated cases, 143 unscored labels, citations, boundaries, filters and share URLs.');
