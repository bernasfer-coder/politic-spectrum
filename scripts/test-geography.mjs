...
assert.equal(GEOGRAPHY_CASES.length, 87);
assert.equal(GEOGRAPHY_LABELS.length, 85);
...
console.log('Geography tests passed: 87 dated cases, 85 unscored labels, citations, boundaries, filters and share URLs.');
