...
assert.equal(GEOGRAPHY_CASES.length, 139);
assert.equal(GEOGRAPHY_LABELS.length, 137);
...
console.log('Geography tests passed: 139 dated cases, 137 unscored labels, citations, boundaries, filters and share URLs.');
