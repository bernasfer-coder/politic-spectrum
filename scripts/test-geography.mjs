...
assert.equal(GEOGRAPHY_CASES.length, 58);
assert.equal(GEOGRAPHY_LABELS.length, 56);
...
console.log('Geography tests passed: 58 dated cases, 56 unscored labels, citations, boundaries, filters and share URLs.');
