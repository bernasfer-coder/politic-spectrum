...
assert.equal(GEOGRAPHY_CASES.length, 194);
assert.equal(GEOGRAPHY_LABELS.length, 192);
...
assert.equal(implementedPost2000.length, 167, 'the atlas should expose all dated post-2000 implemented cases');
