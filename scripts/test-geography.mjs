...
assert.equal(GEOGRAPHY_CASES.length, 190);
assert.equal(GEOGRAPHY_LABELS.length, 188);
...
assert.equal(implementedPost2000.length, 164, 'the atlas should expose all dated post-2000 implemented cases');
