...
assert.equal(GEOGRAPHY_CASES.length, 110);
assert.equal(GEOGRAPHY_LABELS.length, 108);
...
assert.equal(filterGeographyCases({ period: '2000-onward', relationship: 'implemented' }).length, 88, 'the atlas should expose all dated post-2000 implemented cases');
...
console.log('Geography tests passed: 110 dated cases, 108 unscored labels, citations, boundaries, filters and share URLs.');
