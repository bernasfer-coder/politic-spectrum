...
assert.equal(GEOGRAPHY_CASES.length, 99);
assert.equal(GEOGRAPHY_LABELS.length, 97);
...
assert.equal(filterGeographyCases({ period: '2000-onward', relationship: 'implemented' }).length, 77, 'the atlas should expose all dated post-2000 implemented cases');
...
console.log('Geography tests passed: 99 dated cases, 97 unscored labels, citations, boundaries, filters and share URLs.');
