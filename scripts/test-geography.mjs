...
assert.equal(GEOGRAPHY_CASES.length, 48);
assert.equal(GEOGRAPHY_LABELS.length, 46);
...
assert.equal(filterGeographyCases({ period: '2000-onward', relationship: 'implemented' }).length, 26, 'the atlas should expose all dated post-2000 implemented cases');
...
console.log('Geography tests passed: 48 dated cases, 46 unscored labels, citations, boundaries, filters and share URLs.');
