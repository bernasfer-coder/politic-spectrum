...
assert.equal(GEOGRAPHY_CASES.length, 144);
assert.equal(GEOGRAPHY_LABELS.length, 142);
...
console.log('Geography tests passed: 144 dated cases, 142 unscored labels, citations, boundaries, filters and share URLs.');
