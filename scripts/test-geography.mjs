...
assert.equal(GEOGRAPHY_CASES.length, 92);
assert.equal(GEOGRAPHY_LABELS.length, 90);
...
assert.equal(filterGeographyCases({ continent: 'Oceania' }).length, 2);
...
console.log('Geography tests passed: 92 dated cases, 90 unscored labels, citations, boundaries, filters and share URLs.');
