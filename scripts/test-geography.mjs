...
assert.equal(GEOGRAPHY_CASES.length, 103);
assert.equal(GEOGRAPHY_LABELS.length, 101);
...
assert.equal(filterGeographyCases({ period: '2000-onward', relationship: 'implemented' }).length, 81, 'the atlas should expose all dated post-2000 implemented cases');
...
console.log('Geography tests passed: 103 dated cases, 101 unscored labels, citations, boundaries, filters and share URLs.');
