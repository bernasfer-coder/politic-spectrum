...
assert.equal(GEOGRAPHY_CASES.length, 151);
assert.equal(GEOGRAPHY_LABELS.length, 149);
...
assert.equal(filterGeographyCases({ period: '2000-onward', relationship: 'implemented' }).length, 129, 'the atlas should expose all dated post-2000 implemented cases');
...
console.log('Geography tests passed: 151 dated cases, 149 unscored labels, citations, boundaries, filters and share URLs.');
