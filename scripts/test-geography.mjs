...
assert.equal(GEOGRAPHY_CASES.length, 93);
assert.equal(GEOGRAPHY_LABELS.length, 91);
...
assert.equal(filterGeographyCases({ continent: 'Oceania' }).length, 3);
...
console.log('Geography tests passed: 93 dated cases, 91 unscored labels, citations, boundaries, filters and share URLs.');
