...
assert.equal(GEOGRAPHY_CASES.length, 73);
assert.equal(GEOGRAPHY_LABELS.length, 71);
...
console.log('Geography tests passed: 73 dated cases, 71 unscored labels, citations, boundaries, filters and share URLs.');
