...
assert.equal(GEOGRAPHY_CASES.length, 21);
assert.equal(GEOGRAPHY_LABELS.length, 19);
...
console.log('Geography tests passed: 21 dated cases, 19 unscored labels, citations, boundaries, filters and share URLs.');
