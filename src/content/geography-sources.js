...
const sources = [
  ...
  {
    id: 'samoa2025OecElectionSnapshot',
    label: 'Office of the Electoral Commission of Samoa — 2025 General Election at a glance',
    url: 'https://www.oec.gov.ws/',
    note: 'Official OEC homepage consulted for the 2025 election summary. It reports registration, ballots, turnout, candidate and contested-seat statistics; figures are reproduced only as the commission currently labels them. No source wording or graphics are republished, and the dashboard is not an independent election-quality assessment.',
    accessDate: '2026-09-24', creators: ['Office of the Electoral Commission of Samoa'], institution: 'Office of the Electoral Commission of Samoa', publicationDate: null, evidenceRole: 'primary', confidence: 'high', languages: ['English'],
    sourceType: 'official election-summary statistics', identifiers: {},
    description: 'Official electoral commission summary for the 2025 general election. It records 97,111 registered voters, 90,319 ballots cast, 93% turnout, 50 contested seats and 187 candidates on the page consulted; these are time-stamped institutional statistics, not independent validation of election quality.',
  },
  {
    id: 'samoa2025OecElectionExperience',
    label: 'Office of the Electoral Commission of Samoa — General Election 2025: Key Highlights and Electoral Experience',
    url: 'https://www.aweb.org/eng/bbs/B0000041/view.do?delcode=0&menuNo=300104&nttId=16803&pageIndex=1',
    note: 'A-WEB republishes an account attributed to Samoa’s OEC and last updated 31 March 2026. It is retained as the election-management body’s own account, not an independent observer report. Its reported candidate and seat descriptions differ from the OEC homepage summary, so those denominators are not reconciled or used to inflate precision.',
    accessDate: '2026-09-24', creators: ['Office of the Electoral Commission of Samoa'], institution: 'Office of the Electoral Commission of Samoa / Association of World Election Bodies', publicationDate: '2026-03-31', evidenceRole: 'primary', confidence: 'medium', languages: ['English'],
    sourceType: 'election-management agency retrospective', identifiers: {},
    description: 'The OEC’s institutional account of the compressed election timetable and administrative experience, hosted by A-WEB. The report describes voting and administration but is not independent observation; differences in published seat and candidate totals remain visible rather than silently standardized.',
  },
  {
    id: 'samoa2025BudgetVoteAp',
    label: 'Associated Press — Samoa’s leader seeks an early election after opponents reject her budget (27 May 2025)',
    url: 'https://apnews.com/article/32e7b04d63c4e833f9ca85e9a8c74024',
    note: 'Contemporaneous AP reporting consulted for the May budget vote, caretaker-minority context and immediate dissolution request. Vote figures are attributed to the report; it is journalism, not the Legislative Assembly’s verbatim record. No article wording is reproduced.',
    accessDate: '2026-09-24', creators: ['Associated Press'], institution: 'Associated Press', publicationDate: '2025-05-27', evidenceRole: 'secondary', confidence: 'high', languages: ['English'],
    sourceType: 'contemporaneous news report', identifiers: {},
    description: 'Contemporaneous account of the Legislative Assembly’s rejection of the 2025/26 budget by 34 votes to 16 with two abstentions, the government’s minority position and the Prime Minister’s intention to seek dissolution and an early election.',
  },
  {
    id: 'samoa2025ElectionResultsTalamua',
    label: 'Talamua Online — Election official result to be handed today for Head of State’s endorsement (5 September 2025)',
    url: 'https://talamua.com/?p=50869',
    note: 'Samoa-based Talamua report consulted for the Electoral Commissioner’s post-count press conference and locally reported party tally. Statements are attributed to the named election official and remain a news report rather than a substitute for the gazetted writ or constituency returns. No article text is reproduced.',
    accessDate: '2026-09-24', creators: ['Talamua Online'], institution: 'Talamua Online', publicationDate: '2025-09-05', evidenceRole: 'secondary', confidence: 'high', languages: ['English'],
    sourceType: 'Samoan contemporaneous election reporting', identifiers: {},
    description: 'Local reporting of the completed official count and the Electoral Commissioner’s explanation that results were being returned to the Head of State. It records the reported FAST, HRPP, Samoa Uniting Party and independent tally and notes that a further women’s seat would be considered after election petitions.',
  },
  {
    id: 'samoa2025ElectionResultsIpu',
    label: 'Inter-Parliamentary Union — Samoa Legislative Assembly August 2025 election',
    url: 'https://data.ipu.org/parliament/WS/WS-LC01/election/WS-LC01-E20250829/',
    note: 'IPU Parline’s structured election record consulted for the 29 August date, reported party totals, women directly elected and the distinction between party continuity and prime-ministerial change. IPU cites Samoa’s Legislative Assembly, OEC and regional news. Its “51 seats at stake” label differs from the OEC homepage’s “50 contested seats”; both are retained with their source-specific wording.',
    accessDate: '2026-09-24', creators: ['Inter-Parliamentary Union'], institution: 'Inter-Parliamentary Union', publicationDate: null, evidenceRole: 'secondary', confidence: 'high', languages: ['English'],
    sourceType: 'interparliamentary election-results record', identifiers: {},
    description: 'Structured institutional record of Samoa’s August 2025 election and first sitting of the 18th Parliament. It reports FAST 30, HRPP 14, Samoa Uniting Party 3, and 5 women directly elected; the seat denominator is stated as IPU records it and is not silently harmonized with the OEC dashboard.',
  },
  {
    id: 'samoa2025ElectionResultsAp',
    label: 'Associated Press — Samoa’s first woman leader is ousted in an election following the collapse of her government (8 September 2025)',
    url: 'https://apnews.com/article/24a4f16a0c8ed391d88c1b6d572b23f1',
    note: 'AP’s post-count report consulted for the party split, result and expected September parliamentary appointment. Its narrative is kept distinct from official returns and later judicial or parliamentary proceedings. No article wording is reproduced.',
    accessDate: '2026-09-24', creators: ['Associated Press'], institution: 'Associated Press', publicationDate: '2025-09-08', evidenceRole: 'secondary', confidence: 'high', languages: ['English'],
    sourceType: 'contemporaneous election and transition report', identifiers: {},
    description: 'Post-count report on FAST’s majority, the new Samoa Uniting Party’s three seats, HRPP’s result and the expected change in prime minister when the new Parliament met on 16 September. It provides contemporary context, not an account of the later legal status of elected seats.',
  },
  {
    id: 'samoa2025GovernmentPmAddress',
    label: 'Government of Samoa — Prime Minister’s address listed for 16 September 2025',
    url: 'https://www.samoagovt.ws/2025/09/uluai-saunoaga-faa-palemia-a-le-afioga-ia-hon-laaulialemalietoa-polataivao-leuatea-fosi-schmidt-aso-lua-16-setema-2025/',
    note: 'The Government of Samoa’s media center indexes a Samoan-language Prime Minister’s address dated 16 September 2025. The individual page required JavaScript and was not text-accessible in this review; the official listing is used as a primary dated record, not as proof of vote counts or a translated transcript. No speech text is reproduced.',
    accessDate: '2026-09-24', creators: ['Government of Samoa'], institution: 'Government of Samoa', publicationDate: '2025-09-16', evidenceRole: 'primary', confidence: 'medium', languages: ['Samoan'],
    sourceType: 'official prime-ministerial address listing', identifiers: {},
    description: 'Official media-center listing for the incoming Prime Minister’s Samoan-language address on the date Parliament reconvened. The language and access limitation are recorded; this is not used as a substitute for the parliamentary record or an English translation.',
  },
  {
    id: 'samoa2025JapaneseEmbassyTransition',
    label: 'Embassy of Japan in Samoa — From Ambassador: New Government (30 September 2025)',
    url: 'https://www.ws.emb-japan.go.jp/itpr_ja/11_000001_00525.html',
    note: 'Official Japanese Embassy account consulted as independent diplomatic corroboration that Parliament convened, Schmidt was elected Prime Minister and the cabinet was sworn on 16 September. It is an external government’s summary rather than a Samoan court or parliamentary transcript; no text or image is reproduced.',
    accessDate: '2026-09-24', creators: ['Embassy of Japan in Samoa'], institution: 'Embassy of Japan in Samoa', publicationDate: '2025-09-30', evidenceRole: 'secondary', confidence: 'high', languages: ['English', 'Japanese'],
    sourceType: 'diplomatic report on government transition', identifiers: {},
    description: 'Diplomatic summary of the 2025 election result and the 16 September convening, prime-ministerial election and cabinet swearing-in. It corroborates the event date while remaining an external diplomatic record.',
  },
  {
    id: 'samoaGovernanceHufferSoo2000',
    label: 'Elise Huffer and Asofou So’o (eds.) — Governance in Samoa: Pulega i Samoa (2000)',
    url: 'https://openresearch-repository.anu.edu.au/bitstream/1885/132448/1/AP_Press_Governance_in_Samoa.pdf',
    note: 'The full edited volume was consulted for its chapters on civil and political liberty, local government, customary authority and national–village governance. Copyright remains with the authors and publishers; no prose, table, image or scan is reproduced. It provides historical context and does not study the 2025 election.',
    accessDate: '2026-09-24', creators: ['Elise Huffer', 'Asofou So’o'], institution: 'Asia Pacific Press, Australian National University / Institute of Pacific Studies, University of the South Pacific', publicationDate: '2000', evidenceRole: 'secondary', confidence: 'high', languages: ['English'],
    sourceType: 'scholarly edited book on Samoan governance', identifiers: { isbn: '0731536517', secondIsbn: '982020156X' },
    description: 'Edited scholarly volume containing distinct contributions on governance theory, fa’a Samoa, civil and political liberty, local government, matai authority and village governance. Its chapters offer multiple analytical perspectives and are a contextual—not event-specific—source for the 2025 case.',
  },
  {
    id: 'samoaMotusagaHowardWomenPolitics2025',
    label: 'Mema Motusaga and Elise Howard — Weaving a Pacific Narrative into Understanding Women’s Underrepresentation in Politics in Samoa (2025)',
    url: 'https://press-files.anu.edu.au/downloads/press/n14234/pdf/ch09.pdf',
    note: 'The 22-page chapter was read in its open-access ANU Press PDF. It analyzes Samoan gender narratives and political representation with its key election horizon in 2021; it is not used as evidence about the August 2025 result. The chapter is CC BY-NC-ND 4.0; this project links and paraphrases only, without reproducing or adapting its expressive text, images or tables.',
    accessDate: '2026-09-24', creators: ['Mema Motusaga', 'Elise Howard'], institution: 'ANU Press', publicationDate: '2025-12', evidenceRole: 'secondary', confidence: 'high', languages: ['English'],
    sourceType: 'peer-reviewed scholarly book chapter on Samoan political representation', identifiers: { doi: '10.22459/GPR.2025.09', isbn: '9781760467098', onlineIsbn: '9781760467104', pages: '241–262' },
    description: 'A chapter in Gender and Politics Reimagined: Centring Oceanic and Asian Lenses, edited by Tanya Jakimow, Margaret Jolly, Sonia Palmieri and Ramona Vijeyarasa (ANU Press, 2025). It presents a Samoan and non-Indigenous Australian collaborative interpretation of women’s political underrepresentation and the relationship between fa’a Samoa, matai eligibility, parliamentary institutions and gender quota debates, primarily through the 2021 election period.',
  },
  {
