...
const sources = [
  ...
  {
    id: 'indiaWomenReservationAmendment2023',
    label: 'India — Constitution (One Hundred and Sixth Amendment) Act, 2023',
    url: 'https://www.legislative.gov.in/static/uploads/2025/07/677f65dda7c606ba1d13b8430af70555.pdf',
    note: 'Official Legislative Department version of the enacted constitutional amendment. Used to distinguish enactment and its delimitation-dependent commencement condition from the later commencement notification; no provision text or PDF image is republished.',
    accessDate: '2026-09-24', creators: ['Parliament of India'], institution: 'Legislative Department, Ministry of Law and Justice, Government of India',
    publicationDate: '2023-09-28', evidenceRole: 'primary', confidence: 'high', languages: ['English'],
    sourceType: 'primary constitutional amendment / official legal text', identifiers: { actNumber: '106 of 2023', assentDate: '2023-09-28' },
    description: 'Primary legal source for the 2023 women-reservation amendment, including its provision that reservation takes effect after the specified delimitation exercise. The later commencement of the Act is not represented as seats having already been reserved in legislatures.',
  },
  {
    id: 'indiaWomenReservationCommencement2026',
    label: 'India Gazette — commencement notification for the 106th Amendment (16 April 2026)',
    url: 'https://egazette.gov.in/WriteReadData/2026/271834.pdf',
    note: 'Official Gazette notification appointing 16 April 2026 as the commencement date of the 106th Amendment. It is a primary legal record of commencement, not evidence that delimitation or women-reserved seats had then been implemented; no Gazette text or facsimile is reproduced.',
    accessDate: '2026-09-24', creators: ['Ministry of Law and Justice, Government of India'], institution: 'Gazette of India, Extraordinary',
    publicationDate: '2026-04-16', evidenceRole: 'primary', confidence: 'high', languages: ['English'],
    sourceType: 'primary commencement notification / official Gazette', identifiers: { notification: 'S.O. 1922(E)', commencementDate: '2026-04-16' },
    description: 'Official notification setting 16 April 2026 as the commencement date. Commencement of the amendment and operational implementation of reservation are distinct legal stages.',
  },
  {
    id: 'india131stAmendmentBill2026',
    label: 'India — Constitution (One Hundred and Thirty-First Amendment) Bill, 2026, as introduced',
    url: 'https://sansad.in/getFile/BillsTexts/LSBillTexts/Asintroduced/AS%20INTRO416202612944PM.pdf?source=legislation',
    note: 'Official Sansad as-introduced bill text, consulted as a proposal only. It is not enacted law; the motion for consideration did not obtain the constitutionally required majority. No bill wording or page image is republished.',
    accessDate: '2026-09-24', creators: ['Government of India'], institution: 'Lok Sabha / Sansad',
    publicationDate: '2026-04-16', evidenceRole: 'primary', confidence: 'high', languages: ['English'],
    sourceType: 'proposed constitutional amendment / parliamentary bill', identifiers: { billNumber: '107 of 2026', introduced: '2026-04-16', status: 'not passed' },
    description: 'As-introduced proposal to amend constitutional provisions concerning delimitation, representation and the women-reservation framework. The bill is used as a record of a proposal, not as evidence of a legal change.',
  },
  {
    id: 'indiaDelimitationBill2026',
    label: 'India — Delimitation Bill, 2026, as introduced',
    ...
    note: 'Official Sansad as-introduced bill text. It proposed a delimitation process using the bill’s definition of the latest published census; this text did not become law after the linked legislative package was not proceeded with. No bill wording or page image is republished.',
    accessDate: '2026-09-24', creators: ['Government of India'], institution: 'Lok Sabha / Sansad',
    publicationDate: '2026-04-16', evidenceRole: 'primary', confidence: 'high', languages: ['English'],
    sourceType: 'proposed delimitation law / parliamentary bill', identifiers: { introduced: '2026-04-16', status: 'not proceeded with' },
    description: 'As-introduced proposal for a Delimitation Commission and the allocation and reservation of seats. Its provisions are proposals, not an enacted delimitation or seat allocation.',
  },
  {
    id: 'indiaParliamentDebateApril2026',
    label: 'Lok Sabha — debate on the constitutional-amendment bills, 16 April 2026',
    url: 'https://sansad.in/getFile/dms/fetch/b68281ed-eaac-41fc-b3af-e8664dc408e7?source=dsp2',
    note: 'Official parliamentary debate record consulted for attributed arguments raised by members; speeches are political positions, not neutral findings or a representative measure of public opinion. No debate wording, transcript extract or PDF page is republished.',
    accessDate: '2026-09-24', creators: ['Lok Sabha Secretariat'], institution: 'Parliament of India',
    publicationDate: '2026-04-16', evidenceRole: 'primary', confidence: 'high', languages: ['English'],
    sourceType: 'primary parliamentary debate record', identifiers: { sittingDate: '2026-04-16' },
    description: 'Official proceedings for members’ stated positions on the proposed bills, including concerns about timing, representation and delimitation. The record documents speech, not the truth of every assertion made in debate.',
  },
  {
    id: 'indiaGovernmentDelimitationPosition2026',
    label: 'Press Information Bureau — Home Minister’s statement on the delimitation proposals (16 April 2026)',
    url: 'https://www.pib.gov.in/PressReleasePage.aspx?PRID=2252748&lang=1&reg=6',
    note: 'Official government account of the Home Minister’s defence of the proposals. Projections and assurances are attributed to the minister and are not treated as independently validated outcomes; no release wording is reproduced.',
    accessDate: '2026-09-24', creators: ['Press Information Bureau, Government of India'], institution: 'Ministry of Information and Broadcasting, Government of India',
    publicationDate: '2026-04-16', evidenceRole: 'primary', confidence: 'high', languages: ['English'],
    sourceType: 'official executive statement / parliamentary position', identifiers: { releaseId: '2252748', statementDate: '2026-04-16' },
    description: 'Government’s public defence of the proposed package, retained as an attributed executive position rather than an independent forecast or legal finding.',
  },
  {
    id: 'indiaParliamentOutcome2026',
    label: 'Press Information Bureau — outcome of the Lok Sabha consideration motion (April 2026)',
    url: 'https://www.pib.gov.in/PressReleasePage.aspx?PRID=2253254&lang=1&reg=1',
    note: 'Official Ministry of Parliamentary Affairs account that the 131st Amendment Bill did not secure the required Article 368(2) majority on the motion for consideration and that the two dependent bills were not proceeded further. Used for the outcome, not for an unreported vote tally or motive.',
    accessDate: '2026-09-24', creators: ['Ministry of Parliamentary Affairs, Government of India'], institution: 'Press Information Bureau, Government of India',
    publicationDate: '2026', evidenceRole: 'primary', confidence: 'high', languages: ['English'],
    sourceType: 'official parliamentary outcome record', identifiers: { billNumber: '107 of 2026', result: 'motion for consideration did not obtain required majority' },
    description: 'Official summary of the legislative disposition of the amendment proposal and the two dependent bills; no exact vote count is inferred from this record.',
  },
  {
    id: 'indiaParliamentBillDocket2026',
    label: 'Lok Sabha e-Library — Constitution (One Hundred and Thirty-First Amendment) Bill, 2026 (not passed)',
    url: 'https://elibrary.sansad.in/items/74504ab2-6fce-4a36-9444-7d3bb041af84',
    note: 'Official parliamentary docket labels the bill not passed and identifies the 17 April 2026 Lok Sabha record. The parliamentary repository states rights restrictions; link and original summary only, with no transcript, page image or bill text republished.',
    accessDate: '2026-09-24', creators: ['Lok Sabha Secretariat'], institution: 'Lok Sabha e-Library',
    publicationDate: '2026-04-17', evidenceRole: 'primary', confidence: 'high', languages: ['English'],
    sourceType: 'official parliamentary docket / bill-status record', identifiers: { introducedBill: '107 of 2026', status: 'not passed', sittingDate: '2026-04-17' },
    description: 'Official catalog record corroborating the parliamentary status designation. It is not treated as an independent explanation of the failed motion or of political motives.',
  },
  {
    id: 'alamSivaramakrishnanElectoralBoundariesIndia2015',
    label: 'Mohd. Sanjeer Alam and K. C. Sivaramakrishnan (eds.) — Fixing Electoral Boundaries in India: Laws, Processes, Outcomes, and Implications for Political Representation',
    url: 'https://india.oup.com/product/fixing-electoral-boundaries-in-india-9780199458448',
    note: 'Oxford University Press book record and table of contents consulted as book-length context for electoral delimitation, law, representation and political consequences. The full volume was not read in this pass and it does not establish facts about the 2026 bills; no book text is reproduced.',
    accessDate: '2026-09-24', creators: ['Mohd. Sanjeer Alam (editor)', 'K. C. Sivaramakrishnan (editor)'], institution: 'Oxford University Press',
    publicationDate: '2015-08-24', evidenceRole: 'secondary', confidence: 'medium', languages: ['English'],
    sourceType: 'book-length edited volume / publisher record and contents', identifiers: { isbn: '9780199458448', pages: '296' },
    description: 'Edited volume on the law, processes and outcomes of electoral-boundary delimitation in India, including historical and representation-focused chapters. Publisher metadata and contents were consulted, not the complete volume; it supplies historical context, not case-specific findings for 2026.',
  },
  {
    id: 'paiThoratPoliticsRepresentationIndia2022',
    label: 'Sudha Pai and Sukhadeo Thorat (eds.) — Politics of Representation: Historically Disadvantaged Groups in India’s Democracy',
    url: 'https://link.springer.com/book/10.1007/978-981-19-1544-4',
    note: 'Palgrave/Springer publisher record and contents, plus a chapter abstract/catalog record, consulted for book-length context on representation and women legislators. The complete volume and chapter were not read; it is not used as evidence about the 2026 event and no book text is reproduced.',
    accessDate: '2026-09-24', creators: ['Sudha Pai (editor)', 'Sukhadeo Thorat (editor)'], institution: 'Palgrave Macmillan / Springer Nature',
    publicationDate: '2022-10-14', evidenceRole: 'secondary', confidence: 'medium', languages: ['English'],
    sourceType: 'book-length edited volume / publisher contents and chapter abstract', identifiers: { isbn: '9789811915437', ebookIsbn: '9789811915444', doi: '10.1007/978-981-19-1544-4', pages: '288' },
    description: 'Edited volume on the representation of historically disadvantaged groups in Indian democracy, with chapters on women legislators and women’s reservation debates. Publisher contents and one chapter abstract were consulted, not the full text; the volume frames the question but does not document the 2026 bills.',
  },
  {
    id: 'indiaDelimitationFollowupSep2026',
    label: 'The New Indian Express — report on a possible special parliamentary session (23 September 2026)',
    url: 'https://www.newindianexpress.com/india/2026/Sep/23/parliament-special-session-likely-during-navaratri',
    note: 'Contemporary news report based on unnamed sources; it says a special session and a legislative route were under consideration, while explicitly reporting that no final decision had been made. It is a dated follow-up lead, not an official notice or confirmation of future action.',
    accessDate: '2026-09-24', creators: ['The New Indian Express'], institution: 'The New Indian Express',
    publicationDate: '2026-09-23', evidenceRole: 'secondary', confidence: 'medium', languages: ['English'],
    sourceType: 'contemporary newspaper report / attributed follow-up', identifiers: { reportDate: '2026-09-23' },
    description: 'Dated report that government sources described discussion of a special session and possible legislative route, with no final decision reported. It does not establish that a session was formally summoned or that a new bill was introduced.',
  },
  {
