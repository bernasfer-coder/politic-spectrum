...
const RESEARCH_SOURCES = [
  ...
  { id: 'ghdiWeimarGerman', label: 'GHDI — Die Weimarer Verfassung (1919)', url: 'https://germanhistorydocs.org/de/die-weimarer-republik-1918-1933/die-weimarer-verfassung-11-august-1919', note: 'German constitutional excerpts, especially Articles 153, 159, and 165, from the German Historical Institute’s collection. Ellipses mark omitted material; provisions document legal aspirations, not proof of implementation.' },
  ...
  { id: 'bpbSpdProgrammatics', label: 'bpb — Die Programmatik der SPD', url: 'https://www.bpb.de/themen/parteien/parteien-in-deutschland/spd/42085/die-programmatik-der-spd/', note: 'German-language political reference on the SPD’s programmatic history, Godesberg, market regulation, social policy, and later revision.' },
  ...
  { id: 'constituteIran1989', label: 'Constitute Project — Constitution of Iran (1979, revised 1989)', url: 'https://www.constituteproject.org/constitution/Iran_1989', note: 'Constitutional text showing the interaction of Islamic criteria, religious offices, elected institutions, popular sovereignty, and the Guardian Council.' },
