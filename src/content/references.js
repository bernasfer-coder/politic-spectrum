...
export const AUTHOR_REFERENCES = {
  ...
  smithEthnicOrigins: {
    ...
    work: 'The Ethnic Origins of Nations',
    year: '1986',
    kind: 'scholarly',
    context: 'Historical-sociological study of ethnic communities, myths, memories, symbols, and the formation of nations; cited as a scholarly interpretation, not as proof that nations are biologically inherited.',
    url: 'https://www.wiley-vch.de/en/areas-interest/humanities-social-sciences/political-science-12po/political-philosophy-theory-12po5/the-ethnic-origins-of-nations-978-0-631-16169-1',
  },
  connorEthnonationalism: {
    author: 'Walker Connor',
    work: 'Ethnonationalism',
    year: '2015',
    kind: 'scholarly',
    context: 'Comparative reference entry on ethnonationalism as identity and loyalty to a nation understood through a claimed common ancestry; used with caution about terminology and measurement.',
    url: 'https://onlinelibrary.wiley.com/doi/10.1002/9781118663202.wberen301',
  },
  brubakerEthnicityWithoutGroups: {
    author: 'Rogers Brubaker',
    work: 'Ethnicity without Groups',
    year: '2004',
    kind: 'scholarly',
    context: 'Critical analysis of treating ethnicity, race, and nation as fixed bounded groups; used to keep categorization, identification, and political mobilization analytically separate.',
    url: 'https://www.jstor.org/stable/j.ctv1nnwhvg',
  },
  kantPerpetualPeace: {
  ...
  josephusAgainstApion: {
    author: 'Flavius Josephus',
    work: 'Against Apion',
    year: 'c. 93–96 CE',
    kind: 'primary',
    context: 'Ancient primary source commonly associated with an early use of the term theocracy; cited for the historical vocabulary of divine authority, not as evidence for a modern regime type.',
    url: 'https://www.gutenberg.org/ebooks/2849',
  },
  mawardiOrdinances: {
    author: 'Al-Mawardi',
    work: 'The Ordinance of Government (Al-Ahkam al-Sultaniyya)',
    year: 'c. 1058',
    kind: 'primary',
    context: 'Classical Arabic work of Islamic public law on the imam, offices, judges, administration, and governance; it is not treated as a direct blueprint for every modern theocracy.',
    url: 'https://www.nli.org.il/en/books/NNL_ALEPH990020861250205171/NLI',
  },
  khomeiniIslamicRepublic: {
    author: 'Ruhollah Khomeini',
    work: 'Address to the Nation on the Islamic Republic',
    year: '1979',
    kind: 'primary',
    context: 'Historical primary-source record of a revolutionary leader’s public claims about Islamic government and religiously grounded political legitimacy; cited to interpret one Iranian constitutional-religious project, not Islam as a whole.',
    url: 'https://emam.com/posts/view/15352/Speech-%5Bthe-rule-of-law-in-the-Islamic-government%5D',
  },
