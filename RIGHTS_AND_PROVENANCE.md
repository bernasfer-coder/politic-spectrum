...
The inventory includes translations, transcriptions, archive pages, legal instruments, and living oral traditions. Those are separate rights objects from the underlying historical idea or event. Public repositories such as [Perseus](https://www.perseus.tufts.edu/), the [Chinese Text Project](https://ctext.org/), and UNESCO’s [Manden Charter page](https://ich.unesco.org/en/RL/manden-charter-proclaimed-in-kurukan-fuga-00290) are therefore treated as source links to verify, not as automatic permission to copy their text, translations, images, or metadata.[^16][^17][^18] The app currently publishes zero direct quotations, source-page extracts, dataset files, or third-party media from this research-work set.
...
[^16]: Perseus Digital Library, [collection and text access](https://www.perseus.tufts.edu/), accessed 13 September 2026.
[^17]: Chinese Text Project, [project overview and rights information](https://ctext.org/wiki.pl?if=en&res=417200), accessed 13 September 2026.
[^18]: UNESCO, [Manden Charter proclaimed in Kurukan Fuga](https://ich.unesco.org/en/RL/manden-charter-proclaimed-in-kurukan-fuga-00290), accessed 13 September 2026.
