...
describe('geographic atlas', () => {
  ...
  it('keeps Sudan’s post-coup process and later war as separately dated bounded histories', async () => {
    const user = userEvent.setup();
    renderAtlas();
    await user.selectOptions(screen.getByRole('combobox', { name: /Country/ }), 'sudan');
    expect(cards()).toHaveLength(3);
    expect(cards()[0]).toHaveTextContent('1989–2021');
    expect(cards()[1]).toHaveTextContent('25 October 2021–14 April 2023');
